...
/**
 * @brief defines the macro for random rule
 */
#define DISABLE_RANDOM_RULE 1
/**
 * @brief defines the macro for changing a rule
 */
#define RULE_CHANGE 3
...
/**
 * @brief get rulevar in the game
 *
 * @param game
 *
 * @return number of rulevar or -1 in case of error
 */
int game_get_rulevar(Game* game);
/**
 * @brief set space illum in the game
 *
 * @param game
 * @param illum
 * @param pos
...
/**
 * @brief set object hidden in the game
 *
 * @param game
 * @param hide
 * @param pos
