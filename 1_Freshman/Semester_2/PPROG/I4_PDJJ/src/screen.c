...
#include "screen.h"
/**
 * @brief It defines commands
 */
#pragma GCC diagnostic ignored "-Wpedantic"
/**
 * @brief It defines number of rows
 */
#define ROWS 26
/**
 * @brief It defines number of colums
 */
#define COLUMNS 80
/**
 * @brief It defines number of total data
 */
...
#define BG_CHAR '~'
/**
 * @brief It defines space
 */
#define FG_CHAR ' '
/**
 * @brief It defines prompt
 */
#define PROMPT " prompt:> "
/**
 * @brief It defines access
 */
#define ACCESS(d, x, y) (d + ((y) * COLUMNS) + (x))
/**
 * @brief structure of area
 */
struct _Area{
/**
 * @brief It defines variable x
 */
  int x;
/**
 * @brief It defines variable y
 */
  int y;
/**
 * @brief It defines variable width
 */
  int  width;
/**
 * @brief It defines variable height
 */
  int height;
/**
 * @brief It defines variable cursor
 */
  char *cursor;
};
/**
 * @brief It defines variable data
 */
char *__data;
...
/****************************/
/**
 * @brief screen area cursor of bounds
 *
 * @param area
 *
 * @return integer
