...
import exercises_1_to_4.graph.BlackBoxComparator.Criteria;
/**
 * This is the Tester 2 class
 *
 */
public class Tester2 {
	...
	public static void main(String... args) {
		...
		System.out.println("Is there at least one node of g connected to n2? " + g.exists(n -> n.isConnectedTo(n2))); // (*)
																														// true

		g.exists(n -> n.getValue().equals(89));
		// Not satisfied: Optional is null
		g.getWitness().ifPresent(w -> System.out.println("Witness 1 = " + g.getWitness().get()));
		g.exists(n -> n.isConnectedTo(n2));
		// Satisfied: Optional has value
		...
		// We use the comparator to order a list with two graphs
		System.out.println(cgs);
		// prints g (satisfies the 2nd property) and then g1 (satisfies the 2 nd and 3 rd )
