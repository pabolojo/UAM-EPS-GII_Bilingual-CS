...
public class Tester3 {
    ...
    public static void main(String... args) throws ParseException {
        ...
        RuleSet<Product> rs = new RuleSet<Product>();
        // A set of rules applicable to Products
        rs.add(Rule.<Product>rule("r1", "10% discount on products with an expiration date close or past").when(
