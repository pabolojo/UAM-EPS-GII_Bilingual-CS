...
public class Node<A> {
    ...
    public boolean isConnectedTo(Node<A> neighbour) {
        for (Edge<A, ?> e : edges) {
            if (e.getToNode().equals(neighbour)) {
                System.out.println("Node :" + this.number + " and " + neighbour.number + " TRUE");
                return true;
            }
        }
        System.out.println("Node :" + this.number + " and " + neighbour.number + " FALSE");
        return false;
    }
    ...
    public void setValue(A info) {
        System.out.println("NEW VALUE: " + this.number + " -> " + info);
        this.info = info;
    }
    ...
    public List<? extends Object> getEdgeValues(Node<A> n2) {
        ...
        System.out.println("EDGES: " + this.number + " and " + n2.number + " = " + edgeValues.get(0));
        return edgeValues;
    }
