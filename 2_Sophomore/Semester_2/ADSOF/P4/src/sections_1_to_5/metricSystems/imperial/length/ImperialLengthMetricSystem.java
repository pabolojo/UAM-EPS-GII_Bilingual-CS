package  sections_1_to_5.metricSystems.imperial.length;

import sections_1_to_5.metricSystems.*;
import sections_1_to_5.units.types.*;
/**
 * These are the functions and variables that define the ImperialLengthMetricSystem object, the ImperialLengthMetricSystem class.
 *
 */
