/**
* @brief Programa de productor con memoria compartida en un archivo, donde con la ayuda de una cola en forma de memoria compartida
...
int main(int argc, char **argv) {
  ...
  int fd_shm = open(SHF_NAME, O_RDWR | O_CREAT | O_EXCL, S_IRUSR | S_IWUSR);
