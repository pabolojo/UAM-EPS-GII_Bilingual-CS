/**
* @brief Programa de consumidor con memoria compartida en un archivo, donde con la ayuda de una cola en forma de memoria compartida
...
int main(void) {
  ...
  int fd_shm = open(SHF_NAME, O_RDWR | O_EXCL, S_IRUSR | S_IWUSR);
